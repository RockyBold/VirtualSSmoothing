...
class APGDAttack():
    ...
    def ce_loss_specified_dims(self, logits, y_soft, st_dim, end_dim, normlization=False, reduction='none'):
    ...
    def attack_single_run(self, x, y, x_init=None):
        ...
        if not self.is_tf_model:
            ...
            elif self.loss == 'ce-soft-dims':
                raise ValueError('un-supported loss:{}'.format(self.loss))
            else:
