...
def ResNet18(num_real_classes=10, num_v_classes=0, output_real_only=False):
...
def ResNet34(num_real_classes=10, num_v_classes=0, output_real_only=False):
    return ResNet(BasicBlock, [3, 4, 6, 3], num_real_classes=num_real_classes, num_v_classes=num_v_classes,
                  output_real_only=output_real_only)


def ResNet50(num_real_classes=10, num_v_classes=0, output_real_only=False):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_real_classes=num_real_classes, num_v_classes=num_v_classes,
                  output_real_only=output_real_only)


def ResNet101(num_real_classes=10, num_v_classes=0, output_real_only=False):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_real_classes=num_real_classes, num_v_classes=num_v_classes,
                  output_real_only=output_real_only)


def ResNet152(num_real_classes=10, num_v_classes=0, output_real_only=False):
