...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_real_classes=200, num_v_classes=0, output_real_only=False):
...
if __name__ == '__main__':
    ...
    # net = resnet18(num_real_classes=200)
    net = resnet50(num_real_classes=200)
    summary(net, (3, 64, 64))

    # import torchvision.models as models
    # net = models.resnet50(num_classes=200)
    # summary(net, (3, 64, 64))