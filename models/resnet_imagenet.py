...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_real_classes=1000, num_v_classes=0, output_real_only=False):
        ...
        self.fc = nn.Linear(512 * block.expansion, num_real_classes + num_v_classes)
