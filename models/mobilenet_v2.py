...
class MobileNetV2(nn.Module):
    ...
    def __init__(self, num_real_classes=10, num_v_classes=0, normalizer=None, output_real_only=False,
                 output_v_only=False):
...
def mobilenet_v2(num_real_classes=10, num_v_classes=0, normalizer=None, output_real_only=False, output_v_only=False):
    net = MobileNetV2(num_real_classes=num_real_classes, num_v_classes=num_v_classes, normalizer=normalizer,
                      output_real_only=output_real_only, output_v_only=output_v_only, )
    return net
