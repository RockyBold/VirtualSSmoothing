...
class WideResNet(nn.Module):
    def __init__(self, depth, num_real_classes, num_v_classes, widen_factor=1, dropRate=0.0, normalizer=None,
                 output_real_only=False, output_v_only=False, add_real_v=False):
        ...
        self.fc = nn.Linear(nChannels[3], num_real_classes + num_v_classes)
