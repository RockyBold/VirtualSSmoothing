...
#
#     def __init__(self, block, layers, num_real_classes=1000, num_group=32, num_v_classes=0, output_real_only=False):
#         self.inplanes = 64
...
#         num_real_classes = num_real_classes + num_v_classes
#         self.fc = nn.Linear(512 * block.expansion, num_real_classes)
#
...
#             x = self.fc(x)[:, :self.num_real_classes]
#         else:
#             x = self.fc(x)
#         return x
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_real_classes=200, zero_init_residual=False,
                 groups=1, width_per_group=64, replace_stride_with_dilation=None,
                 norm_layer=None, num_v_classes=0, output_real_only=False):
